...
export default function Dashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="lg:ml-64 flex-1 p-3 lg:p-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-4 lg:mb-8 mt-10 lg:mt-0">
            <h1 className="text-xl lg:text-3xl font-bold text-gray-900">Reviews Dashboard</h1>
            <p className="text-xs lg:text-base text-gray-600 mt-1">Monitor and manage guest reviews across all properties</p>
          </div>
